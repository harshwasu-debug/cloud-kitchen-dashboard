...
def _load_deliverect_as_grubtech_schema() -> pd.DataFrame:
    ...
    orders = (
        ...
        .agg(
            ...
            DeliveryCost=("DeliveryCost", "max"),
            DiscountTotal=("DiscountTotal", "min"),      # negative values → min keeps largest abs discount
            SubTotal=("SubTotal", "max"),
            Rebate=("Rebate", "max"),
            Tip=("Tip", "max"),
            DriverTip=("DriverTip", "max"),
            Tax=("Tax", "max"),
            VAT=("VAT", "max"),
            OrderTotalAmount=("OrderTotalAmount", "max"),
            PaymentAmount=("PaymentAmount", "max"),
            Note=("Note", "first"),
...
CUISINE_BRAND_MAP = {
    ...
    "Big Dawg\u2019s Burgers": "American",
    "Big Dawg\ufffd\ufffds Burgers": "American",  # encoding variant from data
...
CPC_BRAND_MAP = {
    ...
    # Talabat / short-form canonical names
    "Annyeong": "Annyeong",
    ...
    "Shanghai Spice": "Shanghai Spice",
    "Smashville Burgers": "Smashville Burgers",
    "Tandoori Tribe": "Tandoori Tribe",
    "The Big Kahuna": "The Big Kahuna",
    "The Curry Club": "The Curry Club",
    "The Patty Pit": "The Patty Pit",
    "The Slider Shack": "The Slider Shack",
    "The Smoky Tandoor": "The Smoky Tandoor",
